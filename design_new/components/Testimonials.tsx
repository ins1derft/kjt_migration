  ...
  return (
    <section className="py-20 bg-brand-gray border-t border-gray-100">
      <div className="container mx-auto px-4">
        ...
        {/* Title */}
        <h2 className="font-heading font-bold text-[40px] md:text-[64px] leading-tight text-center text-brand-dark mb-8">
        ...
        <div className="relative max-w-[1300px] mx-auto group/slider">
            ...
            <div className="overflow-hidden px-2 py-4">
                <div 
                    ...
                    style={{ 
                        // Mobile: 100% width slide. Desktop: 33.333% width slide minus gap adjustments
                        // Using a simple translate percentage based on item width + gap
                        // To keep it responsive without complex calc, we assume desktop shows 3.
                        transform: `translateX(calc(-${currentIndex * 100}%))` 
                    }}
                >
                    {/* Map specific logic for desktop 3 columns inside the transform container */}
                    {/* Actually, simpler approach for responsive:
                        We map all items. 
                        On desktop, each item is width: calc((100% - 2 * 24px) / 3). 
                        On mobile, width: 100%.
                        And we translate by (100% + gap) on mobile, or (33.33% + gap) on desktop.
                    */}
                </div>

                {/* Let's try a grid-based track or simple flex with specific widths */}
                <div 
        ...
        <div className="mt-16 text-center">
            <a href="#" className="inline-block bg-brand-gradient animate-gradient text-white font-heading font-bold text-lg py-4 px-12 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all">
                Leave a review
            </a>
        </div>
