...
const Hero: React.FC = () => {
  ...
  const getSlideStyles = (index: number) => {
    ...
    // We only show Center (0), Right (+1), Left (-1).
    // Others are hidden "behind" the center to allow for smooth recycling.
    ...
    return {
        ...
        className: cn(
            "absolute top-0 w-full h-full rounded-[24px] md:rounded-[40px] overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.25,0.1,0.25,1)] bg-black shadow-xl",
  ...
  return (
    ...
    <section className="relative pt-[120px] pb-6 bg-brand-gray overflow-hidden">
      ...
      {/* 2. Carousel Section */}
      <div className="relative w-full h-[300px] md:h-[500px] lg:h-[600px] flex items-center justify-center mb-10 perspective-1000">
