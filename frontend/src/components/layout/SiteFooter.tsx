...
const catalogLinks = [
  { label: "Interactive Floor", href: "/interactive-floor" },
  { label: "Interactive Mobile Floor", href: "/interactive-floor-mobil" },
  { label: "Interactive Sandboxes", href: "/interactive-sandbox" },
  { label: "Interactive Digital Parks", href: "/interactive-digital-parks" },
        ...
        <div className="space-y-3">
          ...
          <div className="grid gap-2 text-slate-200">
            {catalogLinks.map((link) => (
              <Link key={link.href} href={link.href} className="font-semibold hover:text-white">
                {link.label}
              </Link>
            ))}
          </div>
